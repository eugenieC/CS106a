...
------------------------
Stanford CS106A Baby Names
Adapted from Nick Parlante's Baby Names assignment by
Sonja Johnson-Yu, Kylie Jue, Nick Bowman, Chris Piech,
and Mehran Sahami.

This file defines the functions needed to create the GUI for
the Baby Names program.
...
def make_gui(top, width, height, names, draw_names, search_names):
    ...
    # canvas for drawing
    canvas = tkinter.Canvas(top, width=width, height=height, name='canvas',bg='lightgray')
